...
class AddPensionScreen extends ConsumerStatefulWidget {
  ...
  const AddPensionScreen({super.key, this.title, this.imagePath});
...
class _AddPensionScreenState extends ConsumerState<AddPensionScreen> {
  bool _hasReset = false; // Prevent duplicate resets

  @override
  void didChangeDependencies() {
    super.didChangeDependencies();
    // ✅ Reset ONLY ONCE, after first build is fully done
    if (!_hasReset) {
      _hasReset = true;
