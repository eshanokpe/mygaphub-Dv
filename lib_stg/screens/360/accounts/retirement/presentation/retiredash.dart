...
class _RetiredashState extends ConsumerState<Retiredash> {
  ...
  void _openDOBSheet() {
    showModalBottomSheet(
      ...
      builder: (_) => const RetirementDOBBottomSheet(title: "Date of Birth"),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ Recalculates every build → updates instantly when DOB changes
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          //         colors: [Color(0xFF000000), Color(0xFF404040), Color(0xFF000000)],
          //         stops: [0.0, 0.3, 1.0],
