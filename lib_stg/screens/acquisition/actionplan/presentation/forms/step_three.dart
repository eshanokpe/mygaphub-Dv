                    ...
                    onPressed: state.isNavigating
                        ...
                        : () async {
                            if (_formKey.currentState?.validate() ?? false) {
                              // Save data to controller state
                              controller.updateStep3Item(
                                0,
                                "increase_savings",
                                "New Goal: £${_newAmountController.text.trim()}, Source: ${_explanationController.text.trim()}",
                              );
                              await controller.saveAndContinueLater(context);
                            }
                          },
                    child: state.isNavigating
                        ? SizedBox(
