...
import 'Eaddnote.dart';
import 'education_allocation_summary.dart';
import 'swipeTransaction.dart';

class ViewDetailEduAllocation extends StatefulWidget {
  List<SavingAllserver> item;
  int index;
  ViewDetailEduAllocation({super.key, required this.index, required this.item});
  @override
  State<ViewDetailEduAllocation> createState() =>
      _ViewDetailEduAllocationState();
}

class _ViewDetailEduAllocationState extends State<ViewDetailEduAllocation> {
                                            ...
                                            if (response.statusCode == 400) {
                                              ...
                                              if (savingsresponse.statusCode ==
                                                ...
                                                Fluttertoast.showToast(
                                                  ...
                                                  textColor: Colors.white,
                                                  msg:
                                                      'Education Allocation has been Deleted Successfully',
                                                  toastLength:
                                                      Toast.LENGTH_SHORT,
                                                  gravity: ToastGravity.BOTTOM,
                                                );
  ...
  updateEducationAllocation() async {
    EasyLoading.show(status: 'Loading', dismissOnTap: false);
    // bool result = await isInternetAvailable();
    // if (!result) {
    //   dialogBox.information(
