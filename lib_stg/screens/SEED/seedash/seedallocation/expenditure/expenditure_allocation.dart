...
class ExpenditureAllocation extends StatefulWidget {
  const ExpenditureAllocation({super.key});

  @override
  State<ExpenditureAllocation> createState() => _ExpenditureAllocationState();
}

class _ExpenditureAllocationState extends State<ExpenditureAllocation> {
              ...
              Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton(
                      ...
                      onChanged: (value) {
                        setState(() {
                          expenditurevalue = value as String;
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton(
                            ...
                            onChanged: (value) {
                              setState(() {
                                accommodationvalue = value as String;
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton(
                            ...
                            onChanged: (value) {
                              setState(() {
                                transportationvalue = value as String;
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton(
                            ...
                            onChanged: (value) {
                              setState(() {
                                homefamilyvalue = value as String;
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton(
                            ...
                            onChanged: (value) {
                              setState(() {
                                utilitiesvalue = value as String;
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton(
                            ...
                            onChanged: (value) {
                              setState(() {
                                debtrepaymentvalue = value as String;
                        ...
                        if (_key.currentState!.validate()) {
                          ...
                          if (num.parse(allocationamount) < amun) {
                            ...
                            Fluttertoast.showToast(
                                backgroundColor:
                                    const Color.fromARGB(255, 255, 187, 51),
                          ...
                          var url2 =
                              Uri.parse("$baseUrl/app/seed/allocate/budget");
                          var url3 = Uri.parse("$baseUrl/app/seed/");
                          var urlbudget =
                              Uri.parse("$baseUrl/app/seed/store/budget");
                          ...
                          if (responsebudget.statusCode == 200) {
                            ...
                            if (response.statusCode == 200) {
                              ...
                              if (responseExpen.statusCode == 200) {
                                ...
                                List res = dataExpen;
                                print('data33:$res');
                                List<SavingAllexpenditure> dataExpen0 =
                                    dataExpen
