...
class SeedsTarget extends StatefulWidget {
  final List list;
  const SeedsTarget(this.list, {super.key});
  @override
  _SeedsTargetState createState() => _SeedsTargetState();
}

class _SeedsTargetState extends State<SeedsTarget> {
  Map data = {};
