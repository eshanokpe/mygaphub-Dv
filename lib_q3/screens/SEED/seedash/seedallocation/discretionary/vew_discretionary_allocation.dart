...
import 'Daddnote.dart';
import 'discretionary_allocation_summary.dart';
import 'swipeTransaction.dart';

class ViewDiscretionaryAllocation extends StatefulWidget {
  ...
  @override
  State<ViewDiscretionaryAllocation> createState() =>
      _ViewDiscretionaryAllocationState();
}

class _ViewDiscretionaryAllocationState
    extends State<ViewDiscretionaryAllocation> {
                                            ...
                                            if (response.statusCode == 400) {
                                              ...
                                              if (savingsresponse.statusCode ==
                                                ...
                                                Fluttertoast.showToast(
                                                  ...
                                                  textColor: Colors.white,
                                                  msg:
                                                      'Discretionary Allocation has been Deleted Successfully',
                                                  toastLength:
                                                      Toast.LENGTH_SHORT,
                                                  gravity: ToastGravity.BOTTOM,
                                                );
                                                Navigator.pushReplacement(
                                                  ...
                                                  MaterialPageRoute(
                                                    builder: (context) =>
                                                        DiscretionaryAllocationSummary(
                                                          data: _data,
                                                        ),
                                                  ),
                                                );
              ...
              : Material(
                  ...
                  child: InkWell(
                    onTap: () async {
                      ...
                      try {
                        timer = Timer(const Duration(milliseconds: 20000), () {
                          Navigator.pop(context);
                          EasyLoading.dismiss();
  ...
  updateDiscretionaryAllocation() async {
    EasyLoading.show(status: 'Loading', dismissOnTap: false);
    ...
    if (response.statusCode == 200) {
      ...
      if (response2.statusCode == 200) {
        ...
        if (response.statusCode == 200) {
          ...
          Fluttertoast.showToast(
            backgroundColor: const Color(0xff77A2BB),
            msg: 'Discretionary Allocation has been updated',
            toastLength: Toast.LENGTH_SHORT,
            gravity: ToastGravity.BOTTOM,
          );
          EasyLoading.dismiss();
