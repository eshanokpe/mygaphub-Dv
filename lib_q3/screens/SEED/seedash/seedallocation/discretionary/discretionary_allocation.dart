...
class DiscretionaryAllocation extends StatefulWidget {
  const DiscretionaryAllocation({super.key});

  @override
  State<DiscretionaryAllocation> createState() =>
      _DiscretionaryAllocationState();
}

class _DiscretionaryAllocationState extends State<DiscretionaryAllocation> {
