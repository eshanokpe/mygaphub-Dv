...
import 'savingtransaction_summary.dart';
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (BuildContext ctxt, int index) {
                          return ListTile(
                            ...
                            onTap: () {
                              var recuring = value['list'][index]["recuring"];
                              var allocationid = value['list'][index]["id"];
                              print("spent_last_month:$recuring");
                              print("id:$allocationid");
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => SavingTransactionSummary(
                                    spent_current_month:
                            ...
                            trailing: Text(
                              '$currency${num.parse(value['list'][index]["amount"].toString()).toStringAsFixed(2)}'
                                  .replaceAllMapped(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (BuildContext ctxt, int index) {
                          return ListTile(
                            ...
                            trailing: Text(
                              '$currency${value['list'][index]["amount"].toStringAsFixed(2)}'
                                  .replaceAllMapped(
                                    RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'),
                                    (Match m) => '${m[1]},',
                                  ),
