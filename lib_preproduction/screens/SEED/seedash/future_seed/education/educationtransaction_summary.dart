...
import 'educationeditTransaction.dart';

class EducationTransactionSummary extends StatefulWidget {
  String label;
  String label2;
  var balance;
  String date;
  ...
  @override
  State<EducationTransactionSummary> createState() =>
      _EducationTransactionSummaryState();
}

class _EducationTransactionSummaryState
    extends State<EducationTransactionSummary> {
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              Material(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    // Navigator.of(context).pushNamed("EditEducationTransactionSummary");
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            EditEducationTransactionSummary(
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              '$currency${num.parse(widget.amount).toStringAsFixed(2)}',
                              style: TextStyle(
                                fontSize: width * .050,
