...
class FSEducationAllocationSummary extends StatefulWidget {
  List<SavingAllserver> data;
  FSEducationAllocationSummary({super.key, required this.data});
  @override
  State<FSEducationAllocationSummary> createState() =>
      _FSEducationAllocationSummaryState();
}

class _FSEducationAllocationSummaryState
    extends State<FSEducationAllocationSummary> {
                              ...
                              return Card(
                                ...
                                child: Container(
                                  ...
                                  child: ListTile(
                                    ...
                                    subtitle: Text(
                                      "$currency ${item.summary.totalLeft.toStringAsFixed(2)} Balance",
                                      style: TextStyle(
                                        color: Colors.black,
                                        fontSize: width * .040,
                                        fontWeight: FontWeight.w300,
