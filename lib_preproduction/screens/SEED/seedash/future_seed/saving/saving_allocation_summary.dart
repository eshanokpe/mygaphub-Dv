...
class FS_SavingAllocationSummary extends StatefulWidget {
  List<SavingAllserver> data;
  FS_SavingAllocationSummary({super.key, required this.data});

  @override
  State<FS_SavingAllocationSummary> createState() =>
      _FS_SavingAllocationSummaryState();
}

class _FS_SavingAllocationSummaryState
    extends State<FS_SavingAllocationSummary> {
