...
import 'discretionaryeditTransaction.dart';

class DiscreationaryTransactionSummary extends StatefulWidget {
  String label;
  String label2;
  var balance;
  String date;
  ...
  DiscreationaryTransactionSummary({
    super.key,
    this.allocation_id,
    required this.label,
    this.id,
  ...
  @override
  State<DiscreationaryTransactionSummary> createState() =>
      _DiscreationaryTransactionSummaryState();
}

class _DiscreationaryTransactionSummaryState
    extends State<DiscreationaryTransactionSummary> {
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              Material(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    // Navigator.of(context).pushNamed("EditDiscreationaryTransactionSummary");
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            EditDiscreationaryTransactionSummary(
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              '$currency${(widget.amount as num).toStringAsFixed(2)}',
                              style: TextStyle(
                                fontSize: width * .050,
