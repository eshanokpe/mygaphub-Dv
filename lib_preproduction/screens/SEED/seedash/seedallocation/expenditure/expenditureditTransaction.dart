...
class EditExpenditureTransactionSummary extends StatefulWidget {
  ...
  const EditExpenditureTransactionSummary({
    super.key,
    this.amount,
    this.recuring,
    this.allocationid,
  ...
  @override
  State<EditExpenditureTransactionSummary> createState() =>
      _EditExpenditureTransactionSummaryState();
}

class _EditExpenditureTransactionSummaryState
    extends State<EditExpenditureTransactionSummary> {
  ...
  updateSavingsAllocation() async {
    ...
    const one = "1";
    const zero = "0";
    print('recurings: ${_checked == true ? one : zero}');
