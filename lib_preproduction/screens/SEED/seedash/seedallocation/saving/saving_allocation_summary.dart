...
import 'saving_allocation.dart';
import 'vew_detaila_savings_allocation.dart';

class SavingAllocationSummary extends StatefulWidget {
  List<SavingAllserver> data;
  SavingAllocationSummary({super.key, required this.data});

  @override
  State<SavingAllocationSummary> createState() =>
      _SavingAllocationSummaryState();
}

class _SavingAllocationSummaryState extends State<SavingAllocationSummary> {
                                  ...
                                  child: ListTile(
                                    ...
                                    onTap: () {
                                      final provider = context
                                          .read<Providers>();
                                      provider.allocationItem(widget.data);
                                      provider.allocationIndex(index);

                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) =>
                                              ViewDetailSavAllocation(
                                                item: widget.data,
                                                index: index,
                                              ),
                                        ),
                                      ...
                                      // } catch (e) {
                                      //   // Handle any errors here (e.g., show a toast or dialog)
          ...
          child: InkWell(
            onTap: () {
              Navigator.pushReplacement(context,
                  MaterialPageRoute(builder: (context) => SavingAllocation()));
            },
            child: Padding(
