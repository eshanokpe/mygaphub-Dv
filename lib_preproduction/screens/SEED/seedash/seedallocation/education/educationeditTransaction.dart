...
class EditEducationTransactionSummary extends StatefulWidget {
  ...
  const EditEducationTransactionSummary({
    super.key,
    this.recuring,
    this.amount,
    this.allocationid,
  ...
  @override
  State<EditEducationTransactionSummary> createState() =>
      _EditEducationTransactionSummaryState();
}

class _EditEducationTransactionSummaryState
    extends State<EditEducationTransactionSummary> {
