...
class ViewReportChartDiscretionary extends StatefulWidget {
  ...
  const ViewReportChartDiscretionary({
    super.key,
    this.currency,
    this.data,
    this.title,
  ...
  @override
  State<ViewReportChartDiscretionary> createState() =>
      _ViewHistoricReportChartState();
}

class _ViewHistoricReportChartState
    extends State<ViewReportChartDiscretionary> {
  Map dashData = {};
  Map seedData = {};
  Dio dio = Dio();
  Map historicData = {};
