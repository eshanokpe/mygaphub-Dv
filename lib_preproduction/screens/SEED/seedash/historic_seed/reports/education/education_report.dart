...
import 'viewReportchartEducation.dart';

// ignore: must_be_immutable
class EducationReport extends StatefulWidget {
  ...
  @override
  State<EducationReport> createState() => _EducationReportState();
}

class _EducationReportState extends State<EducationReport> {
                                ...
                                child: Container(
                                  ...
                                  child: ListTile(
                                    ...
                                    onTap: () async {
                                      ...
                                      var token = prefs.getString('tokenDB');
                                      var url = Uri.parse(
                                        "$baseUrl/app/seed/history/${widget.date}/education?label=${item.label}",
                                      );
                                    ...
                                    trailing: Column(
                                      children: [
                                        Text(
                                          '$currency${double.parse(item.amount.toString()).toStringAsFixed(2)} '
                                              .replaceAllMapped(
                                                RegExp(
                                                  r'(\d{1,3})(?=(\d{3})+(?!\d))',
                                                ),
