...
import 'categoryOfProtectionScreen.dart';

class AddProtectionPopup extends StatelessWidget {
  final String title;

  const AddProtectionPopup({
    super.key,
    required this.title,
  }); 
                ...
                _buildContentRow(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const CategoryOfProtectionScreen(),
                      ),
                    );
                  },
                ),
