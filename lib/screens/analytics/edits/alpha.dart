...
class _AlphaState extends State<Alpha> {
  ...
  void initState() {
    ...
    if (widget.alphaInfo!.alpha!['strategy'] != null) {
      _strategy.text = widget.alphaInfo!.alpha!['strategy'].toString();
    }
  }

  String _formatToTwoDecimalPlaces(dynamic value) {
  ...
  Widget build(BuildContext context) {
    String value = context.watch<Providers>().sevengeemodel.steps[6].toString();
            ...
            children: [
              Container(
                decoration: const BoxDecoration(
                  border: Border(
                    left: BorderSide(color: Color(0xff70578C), width: 3),
                  ),
                ),
                child: Padding(
                    ...
                    children: [
                        ...
                        children: [
                          ShaderMask(
                            shaderCallback: (bounds) => const LinearGradient(
                              colors: [Color(0xff3F2C55), Color(0xff70578C)],
                      ...
                      Row(
                        children: [
                          Expanded(
                            child: Text(
                              'A measure of your asset growth funds saved up',
              ...
              Form(
                ...
                child: Column(
                  children: [
                    ...
                    Fiforms(
                      name: 'Target',
                      subtitle: "Usually 6-12 months cost of living",
                      controller: _target,
                      enabled: widget.newUser!,
                      height: height,
                      width: width,
  ...
  save7G() async {
    ...
    try {
      ...
      print(
        "Saving 7G with current: ${_current.text.replaceAll(',', '')}, target: ${_target.text.replaceAll(',', '')}, strategy: ${_strategy.text}",
      );
      String currentValue = _current.text.replaceAll(',', '');
      String targetValue = _target.text.replaceAll(',', '');
      Map<String, dynamic> body = {
        "seveng": "jahgxhnbszjhbxhbhbshsvb",
      ...
      if (response.statusCode == 200) {
        ...
        print(" Fetching updated 7G data from ${response.body}");
        final prefs = await SharedPreferences.getInstance();
        ...
        if (response2.statusCode == 200) {
          ...
          if (response4.statusCode == 200) {
            ...
            if (responseDashboard.statusCode == 200 && mounted) {
              ...
              print("Analytics data after saving 7G: ${analyticsData["data"]}");
