...
class AssetsListCard extends StatelessWidget {
  ...
  String get _frequency {
    final freqStr = ismortgage.toString().trim().toLowerCase();
    if (freqStr.contains('false')) {
      return '';
    }
    return 'Mortgage';
  }

  bool get _isMortgage => _frequency == 'Mortgage';
