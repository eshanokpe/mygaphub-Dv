...
class AddProtectionScreen extends StatefulWidget {
  final String? title;
  const AddProtectionScreen({super.key, this.title});

  @override
  _AddProtectionScreenState createState() => _AddProtectionScreenState();
}

class _AddProtectionScreenState extends State<AddProtectionScreen> with WidgetsBindingObserver {
  //bool _isPaused = true;
