...
class _MoreState extends ConsumerState<More> {
  ...
  Widget build(BuildContext context) {
    ...
    String imgUrl =
         legacy.Provider.of<Providers>(context).details[7]; // legacy provider
                ...
                children: [
                  ...
                  _ToolItem(
                    ...
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (_) => const ActionPlanStrategy()),
                      );
                    }
                  ),
                ], 
  ...
  Future<void> _handleFavourites() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        legacy.Provider.of<Providers>(context, listen: false)
            .setFavorites(reap);
        EasyLoading.dismiss();
  ...
  Future<void> _handleSupport() async {
    final timer = _timeoutTimer(
      onTimeout: () => _dialogBox.information(
  ...
  Future<void> _handleReminder() async {
    final currency =
        legacy.Provider.of<Providers>(context, listen: false).snapshotmodel.currency;
  ...
  Timer _timeoutTimer({required VoidCallback onTimeout}) => Timer(
