...
class _ReapdetailsState extends State<Reapdetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('${widget.reapItem['location']['street']}',
            style: TextStyle(
                color: Colors.black,
        ...
        actions: [
          IconButton(
              ...
              onPressed: () async {
                ...
                context
                    .read<Providers>()
                    .setFavorites(response3.data["assets"]);
          ...
          child: Column(
            children: [
              ...
              Text(
                  ...
                  style: TextStyle(
                      fontSize: width * .04, fontWeight: FontWeight.w300)),
              SizedBox(
                height: height * .05,
              ),
              Container(
                ...
                child: Align(
                  ...
                  child: Text('Property Details'.toUpperCase(),
                      style: TextStyle(
              ...
              ExpandablePanel(
                ...
                expanded: Card(
                  child: Padding(
                      ...
                      child: Text('${widget.reapItem["description"]}',
                          style: TextStyle(
                              fontSize: width * .035,
                                ...
                                child: RichText(
                                    text: TextSpan(
                                        style: TextStyle(
                                            ...
                                            fontWeight: FontWeight.w400),
                                        children: [
                                      const TextSpan(text: 'Property Type: '),
                                      TextSpan(
                                        text:
                                            '${widget.reapItem["special_feature"]["spec_feature1"]}',
                ...
                expanded: Card(
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('${widget.reapItem["neighborhood"]}',
                            textScaleFactor: 1,
                            style: TextStyle(
                                fontSize: width * .035,
                                fontWeight: FontWeight.w400))
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  ...
                  dialogBox.options(context, "Confirm Reserve Asset",
  ...
  Save(assetId) async {
    ...
    if (["", null].contains(details[3])) {
      ...
      var url =
          Uri.parse("$baseUrl/app/acquisition/investment/reap/$assetId");
      ...
      if (!["", null].contains(subjectController.text.trim()) &&
        ...
        var url =
            Uri.parse("$baseUrl/app/acquisition/interest/reap/$assetId");
