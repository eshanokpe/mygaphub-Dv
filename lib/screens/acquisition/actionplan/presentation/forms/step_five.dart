          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4.h),
                _buildSummaryValue(state.category),
                SizedBox(height: 16.h),
                _buildSummaryLabel('Private Pension'),
                SizedBox(height: 4.h),
                _buildSummaryValue(_step2NoteFor(state, 'private_pension')),
                SizedBox(height: 16.h),
                _buildSummaryLabel('Company Pension'),
                SizedBox(height: 4.h),
                _buildSummaryValue(_step2NoteFor(state, 'state_pension')),
                SizedBox(height: 16.h),
                _buildSummaryLabel('State Pension'),
                SizedBox(height: 4.h),
                _buildSummaryValue(_step2NoteFor(state, 'employer_pension')),
              ],
            ),
          ),
          SizedBox(height: 24.h),
