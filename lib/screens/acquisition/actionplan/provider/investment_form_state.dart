...
class InvestmentFormState {
  ...
  final String
  assetGrowthFunds; // ✅ NEW: current Asset Growth Fund balance from seed data
  final String
  personalFund; // ✅ NEW: current Personal Project Fund balance from seed data
  final String
  emergencyFund; // ✅ NEW: current Emergency & Holiday Savings balance from seed data
  ...
  final bool
  step5ShowSummaryScreen; // ✅ NEW: toggles Step 5's Allocation screen vs the final Summary (third) screen
  final int?
  ...
  const InvestmentFormState({
    ...
    this.assetGrowthFunds = '', // ✅ NEW
    this.personalFund = '', // ✅ NEW
    this.emergencyFund = '', // ✅ NEW
    ...
    this.step5ShowSummaryScreen = false, // ✅ NEW
  ...
  InvestmentFormState copyWith({
    ...
    String? assetGrowthFunds, // ✅ NEW
    String? personalFund, // ✅ NEW
    String? emergencyFund, // ✅ NEW
    ...
    bool? step5ShowSummaryScreen, // ✅ NEW
    ...
    return InvestmentFormState(
      ...
      assetGrowthFunds: assetGrowthFunds ?? this.assetGrowthFunds, // ✅ NEW
      personalFund: personalFund ?? this.personalFund, // ✅ NEW
      emergencyFund: emergencyFund ?? this.emergencyFund, // ✅ NEW
      ...
      step5ShowSummaryScreen:
          step5ShowSummaryScreen ?? this.step5ShowSummaryScreen, // ✅ NEW
