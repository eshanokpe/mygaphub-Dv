...
import 'discretionary_allocation.dart';

class FSDiscretionaryAllocationSummary extends StatefulWidget {
  List<SavingAllserver> data;
  FSDiscretionaryAllocationSummary({super.key, required this.data});
  @override
  State<FSDiscretionaryAllocationSummary> createState() =>
      _FSDiscretionaryAllocationSummaryState();
}

class _FSDiscretionaryAllocationSummaryState
    extends State<FSDiscretionaryAllocationSummary> {
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        const FSDiscretionaryAllocation(),
                                  ),
                                );
                              },
                              child: const Padding(
