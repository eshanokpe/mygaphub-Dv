...
class ExpenditureAddNote extends StatefulWidget {
  var item;
  int index;
  ExpenditureAddNote({super.key, required this.index, this.item});

  @override
  State<ExpenditureAddNote> createState() => _ExpenditureAddNoteState();
}

class _ExpenditureAddNoteState extends State<ExpenditureAddNote> {
