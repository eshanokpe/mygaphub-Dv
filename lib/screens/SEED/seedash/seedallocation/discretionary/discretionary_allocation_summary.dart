...
import 'package:GapHub/screens/SEED/seedash/seedallocation/discretionary/discretionary_allocation.dart';
...
import 'vew_discretionary_allocation.dart';

class DiscretionaryAllocationSummary extends StatefulWidget {
  List<SavingAllserver> data;
  DiscretionaryAllocationSummary({super.key, required this.data});
  @override
  State<DiscretionaryAllocationSummary> createState() =>
      _DiscretionaryAllocationSummaryState();
}

class _DiscretionaryAllocationSummaryState
    extends State<DiscretionaryAllocationSummary> {
                              ...
                              return Card(
                                ...
                                child: Container(
                                  ...
                                  child: ListTile(
                                    ...
                                    subtitle: Text(
                                      "$currency ${item.summary.totalLeft.toStringAsFixed(2) ?? 0} Balance",
                                      style: TextStyle(
                                        color: Colors.black,
                                        fontSize: width * .040,
                                        fontWeight: FontWeight.w300,
          ...
          child: InkWell(
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => DiscretionaryAllocation()));
            },
            child: Padding(
