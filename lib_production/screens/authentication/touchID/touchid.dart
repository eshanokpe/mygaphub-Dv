...
class _TouchIDState extends State<TouchID> {
  ...
  bool _isLoadingDashboard = false; // Add this
  String? errorMessage;
  ...
  void _navigateBasedOnResult(Map<String, dynamic> result) {
    ...
    switch (result['route']) {
      ...
      case 'multiStepForm':
        ...
        break;
      default:
        // Show loading for default case too
        setState(() {
          _isLoadingDashboard = true;
        });
  ...
  void _handleSignInError(dynamic error) {
    ...
    setState(() {
      errorMessage = message;
      _isProcessing = false;
      _isLoadingDashboard = false; // Reset loading state on error
      enteredDigits.clear();
    });
