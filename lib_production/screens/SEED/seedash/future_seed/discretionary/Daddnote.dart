...
class DAddNote extends StatefulWidget {
  List<SavingAllserver> item;
  int index;
  DAddNote({super.key, required this.index, required this.item});

  @override
  State<DAddNote> createState() => _DAddNoteState();
}

class _DAddNoteState extends State<DAddNote> {
    ...
    if (response.statusCode == 200) {
      ...
      if (response2.statusCode == 200) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => FSDiscretionaryAllocationSummary(data: _data),
          ),
        );
