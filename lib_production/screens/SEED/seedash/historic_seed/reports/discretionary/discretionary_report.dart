...
import 'viewReportchartdiscretionary.dart';

class DiscretionaryReport extends StatefulWidget {
  final List<HistoricSeedReport>? data;
  final List<dynamic> list;
  final String historicdate;
  final String? date;

  const DiscretionaryReport({
    super.key,
    required this.list,
  ...
  @override
  State<DiscretionaryReport> createState() => _DiscretionaryReportState();
}

class _DiscretionaryReportState extends State<DiscretionaryReport> {
                                ...
                                child: Container(
                                  ...
                                  child: ListTile(
                                    ...
                                    onTap: () async {
                                      ...
                                      var token = prefs.getString('tokenDB');
                                      var url = Uri.parse(
                                        "$baseUrl/app/seed/history/${widget.date}/discretionary?label=${item.label}",
                                      );
                                        ...
                                        RichText(
                                          ...
                                          text: TextSpan(
                                            children: <TextSpan>[
                                              TextSpan(
                                                text:
                                                    'Click any of the items above to view the chart ',
                                                style: TextStyle(
                                                  color: Colors.black,
                                                  fontSize: width * .03,
                                                  fontWeight: FontWeight.w300,
