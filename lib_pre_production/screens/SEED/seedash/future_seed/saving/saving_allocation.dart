...
class FS_SavingAllocation extends StatefulWidget {
  const FS_SavingAllocation({super.key});

  @override
  State<FS_SavingAllocation> createState() => _FS_SavingAllocationState();
}

class _FS_SavingAllocationState extends State<FS_SavingAllocation> {
                        ...
                        if (response.statusCode == 200) {
                          ...
                          if (response3.statusCode == 200) {
                            ...
                            if (response2.statusCode == 200) {
                              ...
                              var data =
                                  savingsbody["data"]['budget_allocations'];
                              List res = data;
                              setState(() {
                                _data = res
                                    .map(
