...
class FSEducationAllocation extends StatefulWidget {
  const FSEducationAllocation({super.key});

  @override
  State<FSEducationAllocation> createState() => _FSEducationAllocationState();
}

class _FSEducationAllocationState extends State<FSEducationAllocation> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async => navigateToPopPage(),
      child: Scaffold(
                      ...
                      if (val == '-Select-') {
                        ...
                        if (num.parse(allocationamount) < amun) {
                          ...
                          Fluttertoast.showToast(
                            ...
                            msg:
                                'You have used up all Available Allocation or Your Education amount is more than your Availabel Allocation  , Please Set Budget Amount ',
                          ...
                          if (response.statusCode == 200) {
                            ...
                            if (response3.statusCode == 200) {
                              ...
                              if (response2.statusCode == 200) {
                                ...
                                //print('send');
                                //print(body);
                                var educationbody = jsonDecode(response2.body);

                                var data =
                                    educationbody["data"]['budget_allocations'];
                                List res = data;
                                setState(() {
                                  _data = res
                                      .map(
                                        (data) =>
                                            SavingAllserver.fromJson(data),
                                      )
                                      .toList();
                                });
                                EasyLoading.dismiss();
                                ...
                                Fluttertoast.showToast(
                                  ...
                                  msg: 'Education Allocation has been created',
                                  toastLength: Toast.LENGTH_SHORT,
                                  gravity: ToastGravity.BOTTOM,
                                );
                              }
