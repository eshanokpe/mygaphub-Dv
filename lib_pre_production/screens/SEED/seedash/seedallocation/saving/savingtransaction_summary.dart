...
import 'savingeditTransaction.dart';

class SavingTransactionSummary extends StatefulWidget {
  String label;
  String label2;
  var balance;
  String date;
  ...
  @override
  State<SavingTransactionSummary> createState() =>
      _SavingTransactionSummaryState();
}

class _SavingTransactionSummaryState extends State<SavingTransactionSummary> {
  var d = DateFormat.yMMMEd();
  late List<SavingAllserver> _data;
                  ...
                  if (response2.statusCode == 200) {
                    ...
                    if (length >= 1) {
                      ...
                      Navigator.pushReplacement(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              SavingAllocationSummary(data: _data),
                        ),
                      );
