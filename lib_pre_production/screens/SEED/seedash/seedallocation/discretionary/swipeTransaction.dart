...
import 'discretionarytransaction_summary.dart';

class SwipeTransaction extends StatefulWidget {
  Map data;
  var totalleft;
  SwipeTransaction({super.key, required this.data, required this.totalleft});
                          ...
                          return ListTile(
                            ...
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => DiscreationaryTransactionSummary(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (BuildContext ctxt, int index) {
                          return ListTile(
                            ...
                            onTap: () {
                              print(
                                'checking_id:${value['list'][index]["id"]}',
                              );
                              Navigator.push(
                                context,
                                MaterialPageRoute(
